...
plot(Mammal_euclidean_clust, main="Mammals Clustered by Std. Milk Composition, Euclidean Metric, Complete Linkage", sub="", xlab= "Mammals", lwd=3, cex.lab=1.25, hang=-1)
```
#frame plot argument?
...
mutate(Mammals_Milk_Std, km_3=MMilk_km_3, km_4=MMilk_km_4) %>%
  select(Water, Protein, Fat, Lactose, Ash)
 ```
