...
```{r}
barplot(wordCounts[1:50], cex.names=0.75)
...
```
***ask how to make it the words that show up at least 20 times
...
```{r}
ggplot(data=news, aes(x=yearmonth, y=count)) + geom_bar(stat="identity") + theme(axis.text=element_text(size=4,angle=90))

#is this right? how to use factor and levels?
```
