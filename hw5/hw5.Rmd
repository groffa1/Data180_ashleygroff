...
```{r}
Vans_Euclidean <- as.matrix(dist(Vans93), colnames(Vans_Euclidean)<-Vans93[,1],
rownames(Vans_Euclidean)<-Vans93[,1], round(Vans_Euclidean, digits=3))
```
...
```{r}
Vans_Manhattan <- as.matrix(dist(Vans93, method="manhattan"),colnames(Vans_Manhattan)<-Vans93[,1],
